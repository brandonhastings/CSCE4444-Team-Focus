...
public class EditWorkoutRequest extends StringRequest {
    ...
    public EditWorkoutRequest(String username, String name, String newname, String exercise1, String exercise2, String exercise3, String exercise4, String exercise5, String exercise6, Response.Listener listener){
